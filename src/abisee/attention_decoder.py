...
def attention_decoder(
    ...
    with variable_scope.variable_scope("attention_decoder") as scope:
        ...
        # attn_vec_size is the length of the vect1ors v, b_attn, (W_h h_i) and (W_s s_t).
        ...
        # encoder_states =   (batch_size, attn_length, 1, attn_size)
        # Wh =               (attn_size, attn_size)
        # encoder_features = (batch_size, attn_length, 1, attn_size)
    ...
    if initial_state_attention:  # true in decode mode
        # Re-calculate the context vector from the previous step so that we can pass it through a linear
        # layer with this step's input to get a modified version of the input
