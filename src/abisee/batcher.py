...
class Example(object):
    ...
    def __init__(self, article: str, abstract_sentences: List[str], vocab: data.Vocab, hps):
        ...
        Args:
            article: already tokenized source text; a string. each token is separated by a single space.
            abstract_sentences: list of already tokenized strings, one per abstract sentence. In each sentence, each token is separated by a single space.
